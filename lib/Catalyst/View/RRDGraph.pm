...
It doesn't depend on RRDs, but I<does> need it to work (and for the tests to pass). You can install RRDs, for instance, using L<Alien::RRDtool>, or compiling it manually from L<http://oss.oetiker.ch/rrdtool/>
...
RRD graph docs: L<http://oss.oetiker.ch/rrdtool/doc/rrdgraph.en.html>, L<http://oss.oetiker.ch/rrdtool/doc/rrdgraph_data.en.html>, L<http://oss.oetiker.ch/rrdtool/doc/rrdgraph_graph.en.html>
